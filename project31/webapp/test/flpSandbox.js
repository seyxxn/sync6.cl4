		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[NPNG-MM] 구매요청 생성",
									"targetURL": "#syncdcmmproject31-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncdcmmproject31-display": {
								"semanticObject": "syncdcmmproject31",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.dc.mm.project31",
									"url": sap.ui.require.toUrl("sync/dc/mm/project31")
								}
							}
						}
					}
