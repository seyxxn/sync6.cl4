		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[D07] Table Practice",
									"targetURL": "#syncd07exercise070701-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncd07exercise070701-display": {
								"semanticObject": "syncd07exercise070701",
								"action": "display",
								"description": "[D07] Table Practice",
								"title": "[D07] Table Practice",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.d07.exercise070701",
									"url": sap.ui.require.toUrl("sync/d07/exercise070701")
								}
							}
						}
					}
