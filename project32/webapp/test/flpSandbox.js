		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[NPNG-PP] 생산흐름 조회",
									"targetURL": "#syncdcppproject32-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncdcppproject32-display": {
								"semanticObject": "syncdcppproject32",
								"action": "display",
								"description": "생산흐름 조회",
								"title": "[NPNG-PP] 생산흐름 조회",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.dc.pp.project32",
									"url": sap.ui.require.toUrl("sync/dc/pp/project32")
								}
							}
						}
					}
