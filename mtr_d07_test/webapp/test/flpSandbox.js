		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[D07] Test",
									"targetURL": "#syncd07mtrd07test-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncd07mtrd07test-display": {
								"semanticObject": "syncd07mtrd07test",
								"action": "display",
								"description": "[D07] Test",
								"title": "[D07] Test",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.d07.mtrd07test",
									"url": sap.ui.require.toUrl("sync/d07/mtrd07test")
								}
							}
						}
					}
