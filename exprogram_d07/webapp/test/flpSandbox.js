		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[D07] 회원정보 조회 및 등록",
									"targetURL": "#cl4exprogramd07-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl4exprogramd07-display": {
								"semanticObject": "cl4exprogramd07",
								"action": "display",
								"description": "회원정보조회",
								"title": "[D07] 회원정보 조회 및 등록",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl4.exprogramd07",
									"url": sap.ui.require.toUrl("cl4/exprogramd07")
								}
							}
						}
					}
