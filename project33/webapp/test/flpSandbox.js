		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[NPNG] 생산흐름 조회",
									"targetURL": "#syncdcppproject33-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncdcppproject33-display": {
								"semanticObject": "syncdcppproject33",
								"action": "display",
								"description": "생산흐름 조회",
								"title": "[NPNG] 생산흐름 조회",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.dc.pp.project33",
									"url": sap.ui.require.toUrl("sync/dc/pp/project33")
								}
							}
						}
					}
