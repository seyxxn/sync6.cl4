		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[D07] Teacher List using OData",
									"targetURL": "#syncd07practice0702-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncd07practice0702-display": {
								"semanticObject": "syncd07practice0702",
								"action": "display",
								"description": "[D07] Teacher List using OData",
								"title": "[D07] Teacher List using OData",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.d07.practice0702",
									"url": sap.ui.require.toUrl("sync/d07/practice0702")
								}
							}
						}
					}
